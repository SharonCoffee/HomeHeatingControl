...
import cs3500.controller.R18_RoomThermometer;
import cs3500.controller.R19_WaterThermometer;
...
class R11_ZonesTest {
    ...
    void zoneAttributesArrayAreGet() {
        Object[] testArray = {"Unknown", zoneState.getZoneStateOn(), targetRoomTemp.getTargetRoomTemp(), 18, targetWaterTemp.getTargetWaterTemp(), 55};
    ...
    void zoneAttributesAreSet() {
        Object[] testArray = {"Downstairs", zoneState.getZoneStateOn(), targetRoomTemp.getTargetRoomTemp(), 18, targetWaterTemp.getTargetWaterTemp(), 55};
