...
public class R11_Zones {
    ...
    Object[] aArrayOfZoneAttributes = {"Unknown", zoneState.getZoneStateOn(), targetRoomTemp.getTargetRoomTemp(), 18, targetWaterTemp.getTargetWaterTemp(), 55};
    ...
    public void setZoneAttribute(int index, Object newAttribute) {
        if ((index == 0 || index == 1) && newAttribute instanceof String) {
            //aArrayOfZoneAttributes[index] = zoneState.setOn(R13_ZoneStateEnum.valueOf((String) newAttribute));
